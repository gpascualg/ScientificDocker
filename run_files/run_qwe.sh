...
$RUNPATH/run_docker.sh --name qwe -s ../ssh_keys/qwe.pub -p 8888:8888 -p 6006:6006 -p 2200:22 -v /qwe/asd:/data -v /asd:/notebooks -e JUPYTER_PASSWORD='$SHA_PASS' -e FETCH_TF_CONTRIB=1 deepstack:tensorflow-1.8
